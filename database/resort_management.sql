...
CREATE TABLE payments (
    ...
    INDEX idx_payment_status  (payment_status),  -- ← thêm index
    INDEX idx_payment_date    (payment_date)     -- ← thêm index
);
...
('admin', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2uheWG/igi.', 'ADMIN', NULL);
