        ...
        <aside className="fixed left-0 top-0 z-50 h-screen w-56 bg-zinc-950 flex flex-col border-r border-zinc-900 shadow-2xl select-none">
            ...
            <div className="px-6 py-6 flex items-center gap-3 border-b border-zinc-900">
                ...
                <div className="flex flex-col">
                    <h1 className="text-zinc-50 font-bold text-base tracking-tight">Resort CMS</h1>
                    <p className="text-zinc-400 text-[11px] uppercase tracking-widest font-bold mt-0.5">Management</p>
                </div>
            </div>
            ...
            {/* 3. NÚT ĐĂNG XUẤT Ở ĐÁY (Rõ chữ, dễ nhìn, không bị chìm) */}
            <div className="px-3 py-4 border-t border-zinc-900 bg-zinc-950/50">
                <button
                    onClick={() => {
                        localStorage.removeItem("token");
                        window.location.href = "/login";
                    }}
                    className="flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium text-zinc-400 hover:bg-red-950/40 hover:text-red-400 w-full transition-all duration-200 group"
                >
